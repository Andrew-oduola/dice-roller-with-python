...
def num_die():
    while True:
        try:
            ...
            valid_response = ['1', 'one', 'two', '2']
            if num_dice.lower() not in valid_response:
                raise ValueError('1 or 2 only')
            else:
                return num_dice
        except ValueError as err:
            print(f"Invalid input: {err}. Please enter either 1 or 2.")
...
def roll_die():
    ...
    while roll_again.lower() == 'yes' or roll_again.lower() == 'y':
        ...
        if amount == '2' or amount == 'two':
            ...
            roll_again = input("Do you want to roll again? (Enter 'yes' or 'y' to roll) ")
        else:
